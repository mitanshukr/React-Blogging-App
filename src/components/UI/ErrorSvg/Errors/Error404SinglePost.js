  ...
  return (
    <div className="SvgStyle__main">
      ...
      <div className="messageBox">
        ...
        <ul>
          <li>The page you're looking for does not exist.</li>
          <li>
            The author might have changed the Access, or have deleted the post.
          </li>
          <li>Make sure the URL you entered is correct!</li>
        </ul>
...
export default _404_SinglePost;
